...
const I18N = {
    es: {
        ...
        'training.title': 'Capacitación <span class="text-olive">TCCC / TECC</span>',
        ...
        'training.i1Title': 'Cursos TCCC:',
        'training.i1Text': 'Tactical Combat Casualty Care para entornos militares y especiales.',
        'training.i2Title': 'Cursos TECC:',
        'training.i2Text': 'Tactical Emergency Casualty Care para respondedores civiles y policiales.',
        'training.i3Title': 'Control de hemorragias:',
        'training.i3Text': 'Básico y avanzado para seguridad física y civil.',
        'training.i4Title': 'Formación de instructores:',
        'training.i4Text': 'Programa de certificación oficial en el Cono Sur.',
        ...
        'testimonials.t3': '"Los cursos TCCC/TECC de BairesTac son excelentes. Formadores certificados, contenido actualizado, y énfasis en la aplicabilidad real. Nuestro equipo se siente preparado."',
        ...
        'faq.a3': 'Sí. BairesTac ofrece cursos certificados TCCC/TECC de menos de 8 horas para NAR y SAM. HemaShock™ requiere entrenamiento médico avanzado. Ofrecemos instructores in situ y formación de capacitadores locales.',
        ...
        'form.success': '¡Gracias! Recibimos tu consulta y te vamos a responder a la brevedad.',
        'form.errRequired': 'Completá los campos obligatorios: nombre, email y mensaje.',
        'form.errEmail': 'Revisá el email: el formato no parece válido.',
        'form.errSend': 'No pudimos enviar el mensaje. Escribinos a bairestacsrl@gmail.com o por WhatsApp.',
    ...
    en: {
        ...
        'training.title': '<span class="text-olive">TCCC / TECC</span> training',
        ...
        'training.i1Title': 'TCCC courses:',
        'training.i1Text': 'Tactical Combat Casualty Care for military and special operations environments.',
        'training.i2Title': 'TECC courses:',
        'training.i2Text': 'Tactical Emergency Casualty Care for civilian and law-enforcement responders.',
        'training.i3Title': 'Bleeding control:',
        'training.i3Text': 'Basic and advanced, for physical security and civilian settings.',
        'training.i4Title': 'Instructor training:',
        'training.i4Text': 'Official certification programme across the Southern Cone.',
        ...
        'testimonials.t3': '"BairesTac’s TCCC/TECC courses are excellent. Certified trainers, up-to-date content and a focus on real-world applicability. Our team feels prepared."',
        ...
        'faq.a3': 'Yes. BairesTac offers certified TCCC/TECC courses of under 8 hours for NAR and SAM. HemaShock™ requires advanced medical training. We provide on-site instructors and local trainer certification.',
        ...
        'form.success': 'Thank you! We received your enquiry and will get back to you shortly.',
        'form.errRequired': 'Please complete the required fields: name, email and message.',
        'form.errEmail': 'Please check the email address: the format does not look valid.',
        'form.errSend': 'We could not send your message. Write to bairestacsrl@gmail.com or reach us on WhatsApp.',
